...
import BotSpecs from '../components/BotDetails'
...
class BotsPage extends Component {
  ...
  componentDidMount() {
    fetch('https://api.npoint.io/f1fe1f82e65a11c5bfca/bots/')
  ...
  removeBotPermanently = (bot) => {
    ...
    fetch(` https://api.npoint.io/f1fe1f82e65a11c5bfca/bots/${bot.id}`, {
      method: 'DELETE'
    }).then(response => response.json())
